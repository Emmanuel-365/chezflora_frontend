...
export const ModalContainer: React.FC<ModalContainerProps> = ({
  ...
  return (
    <div
      ...
      onClick={onClose}
    >
      <div className="absolute inset-0 bg-lightBorder/20 dark:bg-darkBorder/30 backdrop-blur-sm"></div>
      <div
      ...
      >
        ...
        <div className="p-6 overflow-y-auto scrollbar-thin scrollbar-thumb-lightBorder dark:scrollbar-thumb-dark-soft-green scrollbar-track-lightBg dark:scrollbar-track-darkBg flex-1">
          {children}
        </div>
      </div>
    </div>
