...
import { Calendar, MapPin, ChevronLeft, ChevronRight, Loader2, AlertCircle, Share2, Tag, User, ArrowRight, X, Maximize2, Download, Heart, MessageSquare, Clock } from 'lucide-react'
...
const RealisationDetailPage = () => {
    ...
    const fetchRealisation = async () => {
      ...
      try {
        ...
        const realisationData = {
          ...
          tags: response.data.tags || ["Floral", "Event", "Wedding", "Corporate"]
        }
        ...
        setError("Error loading realization details")
        setLoading(false)
      }
    }
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: realisation?.titre || "Project",
        text: realisation?.description || "Check out this project!",
          ...
          <>
                  ...
                  <div className="flex flex-wrap justify-center gap-6 mb-8">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700">
                        {new Date(realisation.date_creation).toLocaleDateString('en-US', {
                          year: 'numeric',
                          month: 'long',
                          day: 'numeric'
                        })}
                    ...
                    {realisation.duree && (
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-700">Duration: {realisation.duree}</span>
                      </div>
                    )}
                  </div>
                </motion.div>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
              <nav className="flex text-sm text-gray-500">
                ...
                <Link to="/realisations" className="hover:text-emerald-600 transition-colors">Projects</Link>
                <span className="mx-2">/</span>
                      ...
                      {realisation.photos.length > 1 && (
                        <>
                          <button
                            ...
                            className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-3 rounded-full hover:bg-opacity-70 transition-opacity"
                          ...
                          <button
                            ...
                            className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-3 rounded-full hover:bg-opacity-70 transition-opacity"
                          ...
                          {realisation.photos.map((photo, index) => (
                            ...
                            >
                              <img
                                ...
                                alt={`${realisation.titre} thumbnail ${index + 1}`}
                                className="w-full h-full object-cover"
                              />
                            </button>
                          ))}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                >
                  <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                    <div className="p-6">
                      <h2 className="text-2xl font-medium text-gray-800 mb-4">Project Details</h2>
                ...
                >
                  <div className="bg-white rounded-xl shadow-sm overflow-hidden sticky top-24">
                    <div className="p-6 border-b border-gray-100">
                      <h2 className="text-xl font-medium text-gray-800">Project Information</h2>
                    </div>
                          ...
                          <div className="p-6">
                            <div className="flex justify-between items-start mb-2">
                              <h3 className="text-lg font-medium text-gray-800 hover:text-emerald-600 transition-colors">
                                <Link to={`/realisations/${related.id}`}>
                                  {related.titre}
                                </Link>
                              </h3>
                            </div>
                            ...
                            <div className="flex items-center text-gray-500 text-sm mb-3">
                              ...
                              <span>
                                {new Date(related.date_creation).toLocaleDateString('en-US', {
                                  year: 'numeric',
                                  month: 'short',
                                  day: 'numeric'
                                })}
                ...
                >
                  <div className="relative w-full h-full flex items-center justify-center" onClick={(e) => e.stopPropagation()}>
                    ...
                    <a
                      ...
                      className="absolute top-4 left-4 bg-black bg-opacity-50 text-white p-2 rounded-full hover:bg-opacity-70 transition-opacity z-10"
                    ...
                    {realisation.photos.length > 1 && (
                      <>
                        <button
                          ...
                          className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-3 rounded-full hover:bg-opacity-70 transition-opacity z-10"
                          aria-label="Previous photo"
                        >
                        ...
                        <button
                          ...
                          className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-3 rounded-full hover:bg-opacity-70 transition-opacity z-10"
                          aria-label="Next photo"
                        >
