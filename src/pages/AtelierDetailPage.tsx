...
const AtelierDetailPage = () => {
  ...
  // Variantes d'animation sans opacité
  const fadeIn = {
    hidden: { y: 20 },
  ...
  const renderLoadingState = () => (
    <div className="flex flex-col items-center justify-center py-20">
      ...
      <p className="text-gray-600">Chargement des détails de l'atelier...</p>
    </div>
  )
                          ...
                          <div className="p-6 bg-gray-50 border-t border-gray-100">
                            <div className="flex items-start">
                              ...
                              <p className="text-sm text-gray-600">
                                L'inscription se termine 24 heures avant l'atelier. Veuillez arriver 15 minutes en
                                avance.
                              </p>
                            </div>
                          </div>
                  ...
                  {relatedAteliers.length > 0 && (
                    <div ref={relatedRef} className="bg-gray-50 py-16">
                      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <motion.div initial="hidden" animate={isRelatedInView ? "visible" : "hidden"} variants={fadeIn}>
