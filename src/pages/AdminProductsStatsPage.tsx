...
const AdminProductsStatsPage: React.FC = () => {
  ...
  const renderChartPlaceholder = (title: string) => (
    <div className="bg-lightCard dark:bg-darkCard p-4 rounded-lg shadow-md animate-pulse">{title}
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            {Array.from({ length: 3 }).map((_, index) => (
              <tr key={index} className="border-b border-lightBorder dark:border-darkBorder">
        ...
        {loading ? (
          <>
            ...
            <div className="space-y-6">
              {renderChartPlaceholder("Ventes par produit")}
              {renderChartPlaceholder("Stock par catégorie")}
              ...
              <div className="bg-lightCard dark:bg-darkCard p-4 rounded-lg shadow-md">
                ...
                <div className="h-48 sm:h-64">
                  <Bar
                    ...
                    options={{
                      ...chartOptions,
                      plugins: { ...chartOptions.plugins, title: { text: `Ventes sur ${daysFilter} jours` } },
                    }}
                  />
                </div>
              </div>
