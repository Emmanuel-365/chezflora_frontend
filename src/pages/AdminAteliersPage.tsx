...
const AdminAteliersPage: React.FC = () => {
  ...
  const fetchAteliers = async () => {
    ...
    try {
      ...
      setAteliers([]); // Réinitialiser à un tableau vide en cas d'erreur
      setLoading(false);
    }
  };
          ...
          <>
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Affichage de {(currentPage - 1) * ateliersPerPage + 1} à {Math.min(currentPage * ateliersPerPage, totalAteliers)} sur {totalAteliers}{" "}
                ateliers
              </p>
